...
export const CompactCampaignCard = memo(({
    id,
    campaignCode,
    name,
    status,
                ...
                <div className="flex items-center justify-between">
                    ...
                    {progress > 0 && (
                        <div className="flex items-center gap-1 text-green-400">
                            ...
                            <span className="text-[10px] font-mono font-bold">ACTIVA</span>
                        </div>
                    )}
                </div>
                                ...
                                {updatedAt && (
                                    <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground">
                                        ...
                                        <span className="font-mono">
                                            Actualizado {formatDistanceToNow(new Date(updatedAt), { addSuffix: true })}
                                        </span>
                                    </div>
                                )}
                                {createdAt && (
                                    <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground">
                                        <Clock className="size-3" />
                                        <span className="font-mono">
                                            Creado {formatDistanceToNow(new Date(createdAt), { addSuffix: true })}
                                        </span>
                                    </div>
                                )}
                            </div>
...
CompactCampaignCard.displayName = "CompactCampaignCard";
